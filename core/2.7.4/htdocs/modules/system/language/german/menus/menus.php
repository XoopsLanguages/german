...
define('MENUS_HOME', 'Startseite');
define('MENUS_ADMIN', 'Verwaltung');
define('MENUS_ACCOUNT', 'Konto');
define('MENUS_ACCOUNT_EDIT', 'Konto bearbeiten');
define('MENUS_ACCOUNT_LOGIN', 'Anmelden');
define('MENUS_ACCOUNT_LOGOUT', 'Abmelden');
define('MENUS_ACCOUNT_REGISTER', 'Registrieren');
define('MENUS_ACCOUNT_MESSAGES', 'Nachrichten');
define('MENUS_ACCOUNT_NOTIFICATIONS', 'Benachrichtigungen');
define('MENUS_ACCOUNT_TOOLBAR', 'Symbolleiste');
