...
define('_XOOPS_SMARTY4_SCANNER_AUTOFIX', 'Kann automatisch korrigiert werden: Die foreach-Elementvariable wird durch Anhängen von „_item“ umbenannt (z. B. wird „foo“ zu „foo_item“).');
...
define(
    ...
    <<<'EOT'
<h3>XOOPS 2.7.0 führt eine wesentliche Änderung ein: Smarty 4</h3>

<p>Leider kann diese Änderung möglicherweise einige ältere Themes beeinträchtigen. Bevor Sie mit dem Upgrade fortfahren, stellen Sie daher bitte sicher, dass Sie die folgenden Schritte befolgen:

<li>Führen Sie preflight.php aus, um nach veralteten Themes oder Modulvorlagen zu suchen.</li>
<li>Wenn Probleme festgestellt werden, konsultieren Sie dieses Dokument, um die erforderlichen Änderungen zu verstehen, bevor Sie mit dem Upgrade fortfahren.</li>
<li>Nachdem Sie die erforderlichen Änderungen vorgenommen haben, führen Sie preflight.php erneut aus.</li>
<li>Wenn keine weiteren Probleme auftreten, können Sie mit dem Upgrade-Vorgang beginnen.</li>
</p>
EOT,
);
